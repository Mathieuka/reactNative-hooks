...
const ClientStatusInfo = (props) => {
    ...
    const [colorOfBackground, setBackgroundColor] = useState('red')
    ...
    },[clientId,colorOfBackground]);//NOTE: <== we can specify re-run the Effect only if "clientId" change by passing an array in second argument;
